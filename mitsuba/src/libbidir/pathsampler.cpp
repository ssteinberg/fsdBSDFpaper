        ...
        case EBidirectional: {
                ...
                if (offset == Point2i(-1))
                    ...
                    m_sensorSubpath.randomWalkFromPixel(m_scene, m_sensorSampler,
                        m_sensorDepth, offset, m_rrDepth, false, m_pool);
                    ...
                    for (int t = maxT; t >= minT; --t) {
                        ...
                        if (vs->isEmitterSupernode()) {
                            ...
                            value = radianceWeights[t] *
                                vs->eval(m_scene, vsPred, vt, EImportance, false) *
                                vt->eval(m_scene, vtPred, vs, ERadiance, false);
                            ...
                            if (s == 1) {
                                ...
                                value *= vt->eval(m_scene, vtPred, vs, ERadiance, false);
                                vt->measure = EArea;
                            } else {
                                if (vs->isDegenerate())
                                    continue;
                                ...
                                value *= vs->eval(m_scene, vsPred, vt, EImportance, false);
                                vs->measure = EArea;
                            }
