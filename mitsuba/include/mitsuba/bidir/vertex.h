...
struct MTS_EXPORT_BIDIR PathVertex {
    ...
    bool sampleNext(const Scene *scene, Sampler *sampler,
        ...
        bool intensityDistribution, ETransportMode mode, bool russianRoulette = false,
    ...
    Spectrum sampleDirect(const Scene *scene, Sampler *sampler,
        ...
        bool intensityDistribution, ETransportMode mode) const;
     ...
     */
    Spectrum eval(const Scene *scene, const PathVertex *pred, const PathVertex *succ, ETransportMode mode, bool intensityDistribution, EMeasure measure = EArea) const;
    ...
    Float evalPdf(const Scene *scene, const PathVertex *pred,
        const PathVertex *succ, ETransportMode mode, bool intensityDistribution, EMeasure measure = EArea) const;
